...
public class SmartTabLayout extends HorizontalScrollView {
  ...
  private OnSelectedTabListener onSelectedTabListener; // add by hubing
  ...
  public SmartTabLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    isSpecial = a.getBoolean(
            R.styleable.stl_SmartTabLayout_stl_special, special);
    a.recycle();
    ...
    this.tabStrip.setIsSpecial(isSpecial);
  ...
  public void setCustomTabView(int layoutResId, int textViewId) {
    ...
    if(tabStrip!=null){
      tabStrip.setTabViewTextViewId(textViewId);
    }
  }
  ...
  private void populateTabStrip() {
    ...
    if(onSelectedTabListener!=null){
      onSelectedTabListener.onSelectedTabView(viewPager.getCurrentItem(),tabStrip);
    }
  }
  ...
  public interface  OnSelectedTabListener{
    ...
    void onSelectedTabView(int position, ViewGroup tabs);

  }

  public interface OnInitTabListener{
    void onInitTabView();
  }
    ...
    public void onPageSelected(int position) {
      ...
      for (int i = 0, size = tabStrip.getChildCount(); i < size; i++) {
        ...
        if(position == i){
          ...
          if(onSelectedTabListener!=null){
            onSelectedTabListener.onSelectedTabView(i,tabStrip);
          }
        }else {
