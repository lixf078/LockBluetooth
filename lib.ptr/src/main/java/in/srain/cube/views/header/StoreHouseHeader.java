package in.srain.cube.views.header;
...
import in.srain.cube.views.ptr.header.*;
...
public class StoreHouseHeader extends View implements PtrUIHandler {
    ...
    public void initWithString(String str, int fontSize) {
        ArrayList<float[]> pointList = in.srain.cube.views.ptr.header.StoreHousePath.getPath(str, fontSize * 0.01f, 14);
