...
public abstract class BaseFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mSocialShareUitl = SocialShareUtil.getInstance(getActivity());
    ...
    protected void socialShare(SocialShareUtil.Share share){
        if(share!=null){
            if(!TextUtils.isEmpty(share.webUrl)){
                mSocialShareUitl.shareImageAndContent(getActivity(),share);
            }
        }
    }

    protected void socialShareImgOnly(SocialShareUtil.Share share){
        mSocialShareUitl.shareOnlyPictureTo(getActivity(),share);
    }
